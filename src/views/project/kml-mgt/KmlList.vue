<template>
  ...
  <a-modal
    ...
    footer=""
  >
    <kml-add :project="project"></kml-add>
  </a-modal>
  ...
  <a-modal
    ...
    footer=""
  >
    <kml-edit :formData="formData"></kml-edit>
  </a-modal>
</template>
<script>
...
import { deleteKml, listKml } from "../../../assets/js/api_v2";
import KmlAdd from "./KmlAdd.vue";
import KmlEdit from "./KmlEdit.vue";
