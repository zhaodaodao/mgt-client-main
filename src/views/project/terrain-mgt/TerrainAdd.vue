<template>
  <a-form ref="formRef" :model="formState" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
    <a-form-item ref="name" label="地形(DEM)文件名" name="name">
...
import { addTerrain, APP_NAME } from "../../../assets/js/api_v2.js";
