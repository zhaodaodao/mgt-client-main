<template>
  ...
  <a-modal
    ...
    footer=""
  >
    <terrain-add :project="project"></terrain-add>
  </a-modal>
  ...
  <a-modal
    ...
    footer=""
  >
    <terrain-edit :formData="formData"></terrain-edit>
  </a-modal>
</template>
<script>
...
import { deleteTerrain, listTerrain } from "../../../assets/js/api_v2";
import TerrainAdd from "./TerrainAdd.vue";
import TerrainEdit from "./TerrainEdit.vue";
