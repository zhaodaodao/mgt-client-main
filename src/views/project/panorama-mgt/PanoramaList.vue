<template>
  ...
  <a-modal
    ...
    footer=""
  >
    <panoprama-add :project="project"></panoprama-add>
  </a-modal>
  ...
  <a-modal
    ...
    footer=""
  >
    <panorama-edit :formData="formData"></panorama-edit>
  </a-modal>
</template>
<script>
...
import { deletePanorama, listPanorama } from "../../../assets/js/api_v2";
import PanopramaAdd from "./PanoramaAdd.vue";
import PanoramaEdit from "./PanoramaEdit.vue";
